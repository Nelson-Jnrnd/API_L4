...
Then you can access the MockMock web interface by opening a web browser and typing [localhost:8282](http://localhost:8282) in the address bar. Here you can see the mails received by MockMock.
